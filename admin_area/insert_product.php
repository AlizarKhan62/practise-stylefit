...
// Check if product_images directory exists, create if not
...
if($_FILES['product_img1']['error'] == 0 && $_FILES['product_img2']['error'] == 0 && $_FILES['product_img3']['error'] == 0) {

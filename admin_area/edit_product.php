...
// Only move uploaded files if they exist and are not empty
if(!empty($_FILES['product_img1']['name']) && $_FILES['product_img1']['error'] == 0){
    move_uploaded_file($temp_name1,"product_images/$product_img1");
}

if(!empty($_FILES['product_img2']['name']) && $_FILES['product_img2']['error'] == 0){
    move_uploaded_file($temp_name2,"product_images/$product_img2");
}

if(!empty($_FILES['product_img3']['name']) && $_FILES['product_img3']['error'] == 0){

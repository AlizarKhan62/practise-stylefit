		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="payment_options.php" class="footer-nav__link">Secure shipping</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="my_account.php?my_wishlist" class="footer-nav__link">Wishlist</a>
					</li>
					<li class="footer-nav__item">
						<a href="my_account.php?my_orders" class="footer-nav__link">Track an order</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				180-182 Regent Street, Faislabad.
			</address>
				<div class="phone">
					Telephone:
	...
	<!-- <div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Award winner</span><br> Fashion awards 2018
			</div>
